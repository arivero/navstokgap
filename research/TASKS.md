...
| --- | --- | --- | --- | --- |
| N01 | selected | Point insertion, Newton's areas and a minimum action: state what one inserted impulse point in Newton's polygon must carry (minimum swept sector, action or time step) for a floor to survive refinement; test against C027--C029 and C052/C130 | Coordinator; STRATEGY decision format; bounded review before promotion | [I002](../ideas/I002-newton-polygon-threshold.md); [cut target](CUT_POINT_TARGET.md); user direction 2026-09-14 |
