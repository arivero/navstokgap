...
| G07 | done | Mass-gap/action-floor dictionary: floor/unit theorem for both observables, written Yang--Mills quantum-mechanical gap with explicit $\hbar,g,m$ scaling and gapless abelian/classical limits, free-field and 2D cases, quantum-mechanical transmutation, supplied/generated classification of the gap track; exploratory, no ledger promotion | Coordinator (Claude Fable 5.1), user direction 2026-09-16 | [Handoff](handoffs/G07.md); [note](../notes/low-dimensional-mass-gap.md); B78; C01 companion map partly discharged |
| G08 | done | Floor-to-gap and gap-to-unit inside the Yang--Mills quantum-mechanical model: transverse area floor $h/2$ confines the valley to $|x|\le2\sqrt mE/(\hbar g)$, reproduces Simon's $E^{3/2}\ln E$ counting growth and the exact energy unit by Bohr--Sommerfeld; commutative model inert; gap forces the action unit $\Delta^{3/4}m^{1/2}g^{-1/2}$, equivalence holding for dimensionful classical couplings and failing at $d=4$; exploratory, no promotion | Coordinator (Claude Fable 5.1), user direction 2026-09-16 | [Handoff](handoffs/G08.md); [note](../notes/action-floor-yang-mills-gap.md); B79; G07 |
