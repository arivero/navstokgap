...
| --- | --- | --- | --- | --- |
| N01 | done, supporting | Galileo area/action normalization and repo direction corrected; supplied-hbar closed-force phase is a benchmark, not a necessity theorem | Coordinator written review; no ledger promotion | [Handoff](handoffs/N01.md); [derivation](../notes/newton-insertion-action.md) |
| N02 | selected | Construct and decisively test one non-quantum consistency principle for joint time/position refinement of the Galileo comparison; derive a zero-action contradiction or a countermodel, with cut state/composition/limits explicit | Coordinator; new principle and construction, review before promotion; no supplied-hbar or finite-budget substitute | User seeks mathematical necessity; I003 originating question; C027--C029 and full-state classical cuts are existing countertests |
...
| G07 | done | Mass-gap/action-floor dictionary: floor/unit theorem for both observables, written Yang--Mills quantum-mechanical gap with explicit $\hbar,g,m$ scaling and gapless abelian/classical limits, free-field and 2D cases, quantum-mechanical transmutation, supplied/generated classification of the gap track; Theorems 1, 5--6 promoted as C131, C133 after [written review](../reviews/mass-gap-dictionary-G07.md); the rest exploratory | Coordinator (Claude Fable 5.1), user direction 2026-09-16 | [Handoff](handoffs/G07.md); [note](../notes/low-dimensional-mass-gap.md); B78; C01 companion map partly discharged |
| G08 | done | Floor-to-gap and gap-to-unit inside the Yang--Mills quantum-mechanical model: transverse area floor $h/2$ confines the valley to $|x|\le2\sqrt mE/(\hbar g)$, reproduces Simon's $E^{3/2}\ln E$ counting growth and the exact energy unit by Bohr--Sommerfeld; commutative model inert; gap forces the action unit $\Delta^{3/4}m^{1/2}g^{-1/2}$, equivalence holding for dimensionful classical couplings and failing at $d=4$; Propositions 4--5 promoted as C132 after [written review](../reviews/mass-gap-dictionary-G07.md); Theorem 2 and semiclassical remarks exploratory | Coordinator (Claude Fable 5.1), user direction 2026-09-16 | [Handoff](handoffs/G08.md); [note](../notes/action-floor-yang-mills-gap.md); B79; G07 |
| Q14 | done | Dimensional and similarity criteria for a universal action floor: fixed action product necessary, admitted similarity forces zero; C052's k/c identified as the unique mass-independent electromagnetic unit, alpha times hbar; Coulomb collapse remark audited against Klein--Gordon and Dirac ([review](../reviews/kepler-collapse-Q14.md)); collapse correspondence promoted as C130 by user direction, criteria exploratory | Coordinator (Claude Fable 5.1); written review and bounded librarian before promotion | [Handoff](handoffs/Q14.md); C052--C061, Q02--Q13, ACTION_FIELD_TARGET 2, 4 |
...
| Q02 | done | Exploratory radiation-balance test: cubic field spectrum gives probe-independent action in the weak-damping limit; amplitude free, quiet state admitted, cutoff removal diverges; no ledger promotion | Coordinator + one Sol-medium review | [Handoff](handoffs/Q02.md); [Review](../reviews/radiation-noise-Q02.md); ACTION_FIELD_TARGET 2--5 |
...
| P06 | done | Standalone spin manuscript, compiled PDF and provenance-checked bundle; C125–C128/B70 consistency review | Coordinator | [Handoff](handoffs/P06.md); publication positioning remains |
| P06a | done | Worked-example positioning; transformation-relative equivalence clarified; citations and PDF bundle updated | One sequential Sol medium, coordinator integration | [Handoff](handoffs/P06a.md); B76 |
| B76 | done | Four queries, two papers/eight pages; classical-extension and preparation-equivalence precedents | One sequential Sol medium | [Review](../reviews/spin-publication-B76.md) |
| P07 | done | Both manuscripts edited for accessibility and contribution; author decision sheet complete; author details and destination remain | Coordinator, reused existing audits | [Handoff](handoffs/P07.md); [decision sheet](../reviews/publication-readiness-P07.md); no new mathematical result |
...
| Q01 | generator restriction accepted | C128/B74 rules out finite repair; C129/B77 audits B70 equations (8)–(14); projector continuation parked by user correction; next work must test a physical selection mechanism | Coordinator + sequential librarians | [Generator handoff](handoffs/Q01-generator-audit.md); full reconstruction remains unaudited |
...
G04's physical-operator transfer is complete; Q01's finite-repair decision and initial generator audit are complete; STATE selects physical-mechanism work; serial borrowed-proof audits are parked. Each milestone is bounded; an incomplete parent task does
