...
phase-state composition intact. R04 next retains tagged momentum while
eliminating an independent receiver mode, testing the additional memory
exposed by Zwanzig's reduced equation.
\end{document}
