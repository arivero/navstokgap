...
position uncertainty the marks' recoils produce at time \(u\) measured
from the chord, with \(G_\tau\) the Dirichlet Green's function of the
interval: at every moment the force is paid in the smaller of the two
lengths (path-length note, Theorem M).
