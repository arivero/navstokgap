...
included (\href{additive-noise-marks.md}{additive-noise note}). What
lies outside is noise that depends on the body, where Ozawa's relation
(PRA \textbf{67}, 042105, 2003) adds the body's own spreads; the proved
calibration relation of Busch, Lahti and Werner (PRL \textbf{111},
160405, 2013) is the other route. No error--disturbance relation is used
above.
