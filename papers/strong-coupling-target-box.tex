...
where \(E'(\sigma)\ge(1-\eta_E)\,\varepsilon|S(\sigma)|\), each \(d_j\)
is gauge invariant and acts on at most \(q\) links, and
\(\sum_{j\ni\ell}\|d_j\|\le\eta\,\hbar c/a\) for every link \(\ell\), at
some scale \(a\) with \(g^2\) and \(\eta\) in the region below has a gap
of at least \(4\lambda=\frac83g^2(1-\eta_E)(1-\theta)\,\hbar c/a\)
...
in units \(\hbar c/a\) for the adjacent-growth count; the rigorous
general count multiplies the per-step factor by \(24\), so the same
table holds at \(24\) times the coupling, \(g^2=2400,4800,9600\), or at
the listed couplings with tolerances divided by \(24\). The tolerance
grows linearly in \(g^2\) as
