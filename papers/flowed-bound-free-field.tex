...
must for \(m=0\), so the inequality is not vacuous. And in the
...
the breakdown of the \(1/\sqrt{8t}\) scaling is not a defect of the
estimate but the content of the problem. \textbf{Proving \(m<\infty\)
requires the value of one susceptibility at the confinement scale, and
no expansion around the free theory supplies it.}
