...
The second-variation framework is classical \cite[\S8.2]{Cristoferi2016CalculusVariations}.
...
comparison with the quantum oscillator Hamiltonian. The companion working draft
\emph{A Gap Laboratory: Oscillators, Circles and Winding Sectors} derives both
spectra, their domains and their distinct gap-closing limits.
...
\cite[\S7.3, (7.30)]{Teschl2009}. The expansion below is its Fourier consequence.
For $\hbar,m,\tau>0$ let
\[
...
The following is a pure-state specialization of the Holevo--Helstrom theorem
\cite[Theorem 3.4]{Watrous2018}, followed by the specified action-phase encoding.
...
earlier mathematical scripts are historical artifacts. \texttt{make papers} rebuilds this note
and the companion programme PDF. The formalisation queue begins with the
small-amplitude polynomial lemma.

The companion \emph{Time Refinement and an Action Scale} develops the free
Gaussian blocking test. Next steps audit the regulator proposal and quantum
reconstruction axioms, alongside central-potential models and the historical
corpus inventory, with sequential source audits.
A successful extension must
