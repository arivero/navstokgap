...
an assigned collection of experiments. A dynamical law on those states must
preserve this equivalence: initially equivalent preparations must remain
equivalent after the same evolution. This condition concerns the sufficiency
of the description, independently of whether the microscopic equations are
reversible.

Restricted classical models and minimal tensor products provide a standard
way to separate local statistics from composition \cite{janotta}. Quantum
...
measurement statistics of this model.
