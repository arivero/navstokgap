...
\begin{quote}
\textbf{Superseded in part.} The competition below between
\(e^{-c\eta^2/g^2}\) and \(e^{2\eta}\) holds at fixed truncation range;
letting the range grow like \(\eta\) removes it, and the real
obstruction in the large-field region is the sign of the error, see
