...
error probability tends to zero as the grid's teeth are narrowed at
fixed spacing.
...
bound, about \(2.1\) at five per cent error, however strongly it is
squeezed. The recoil-weighted sagitta is the right universal resource:
