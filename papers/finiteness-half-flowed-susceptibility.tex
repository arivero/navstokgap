...
\(k_1,k_2\) are computed in \href{flowed-bound-free-field.md}{the
free-field note}: \(k_1\propto g^4\) and \(k_2\propto g^2\), so the
ratio carries \(g^{-2}\) and \textbf{the factor \(g^2\) written above
cancels}. The corrected free-field bound is
\(m\le\frac{16\sqrt2}{3\sqrt\pi}\hbar c/\sqrt{8t}\approx4.26\,\hbar c/\sqrt{8t}\),
of order \(g^0\). The \(t\)-dependence below is unaffected; the \(g^2\)
in the displayed inequality and in \(\sqrt{8t_*}\) should be read as
\(O(1)\). Two readings.
