...
Remark, unaudited. The corresponding quantum Coulomb problems place
their collapse thresholds at \(Z\alpha=1/2\) for the Klein--Gordon
\(l=0\) state and \(Z\alpha=1\) for the Dirac \(j=1/2\) state; the
classical condition with \(|L|=\hbar(l+1/2)\) reproduces the first. This
standard comparison belongs to the bounded source review required before
any promotion of this note.
