...
\((\sum_p\|w_p\|)^2\) by \(\sum_p\|w_p\|^2\), is not a missing
ingredient: it is what the expansion produces, and the way to use it is
to apply the theorem itself to the blocked system rather than to
re-derive a Schur bound.
