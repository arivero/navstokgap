...
inscribed polygon, a c-number that no preparation moves; the mark cost
converts it into the largest statistical distance any record of the
motion can reach. At \(\kappa=\hbar/2\) the second is exactly twice the
first. The \(24\) in Theorem 1's \(F^2\tau^3/24m\) and in the sharp
bound \(d^2\le F^2\tau^3/24m\kappa\) of the paper's Theorem 2 is one
integral, \(\iint G_\tau=\tau^3/12\), multiplied by \(F^2/2m\).
