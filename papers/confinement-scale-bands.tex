...
\emph{Caveat, 2026-09-23.} The \(m_{0^{++}}a\) column scales the
continuum ratio to each coupling. Near \(\beta_W\simeq5.7\) the Wilson
axis passes beside the endpoint of the fundamental--adjoint first-order
line, where the scalar glueball softens (Heller 1995), so the lattice
\(\xi/a\) there is likely larger than \(0.70\) and should be taken from
the measured lattice mass (\href{mass-gap-openings.md}{openings note},
§1).
