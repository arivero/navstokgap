...
\item
  ...
  have; for \(SU(N)\) none of this type is known, Section 1 says where
  the standard constructions break, and the centre-based comparison
  inequalities that do exist concern the string tension rather than the
  vacuum-sector gap.
\item
