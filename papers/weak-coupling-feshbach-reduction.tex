...
This is the lower side of the small-volume corner S, matching the upper
side obtained in \href{polyakov-average-gap-bound.md}{the
...
gauge-invariant cutoff, and the constants \(C_i\) grow with
\(\log(L/a)\) on a lattice: the reduction holds at fixed cutoff, and the
cutoff dependence is exactly the running of the coupling.
