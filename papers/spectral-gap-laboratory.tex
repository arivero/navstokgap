...
The repository's \texttt{make check} verifies the maintained algebra and finite
cross-checks; \texttt{make papers} builds the manuscripts and checks references
