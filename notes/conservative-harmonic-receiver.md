...
the same four records after fixed latency $T$. A causal new-information task
with restricted record precision remains R07; no positive universal action
scale follows from the upper mass, duration and force resources alone.
