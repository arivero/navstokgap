...
$$\mathcal C(g,\eta,\eta_E,q)=\Big\{H_E'-\tfrac1{g^2}\textstyle\sum_pw_p-\sum_jd_j\Big\},$$
where $E'(\sigma)\ge(1-\eta_E)\,\varepsilon|S(\sigma)|$, each $d_j$ is
gauge invariant and acts on at most $q$ links, and
$\sum_{j\ni\ell}\|d_j\|\le\eta\,\hbar c/a$ for every link $\ell$,
